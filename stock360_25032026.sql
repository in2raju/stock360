...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 25, 2026 at 11:52 AM
...
INSERT INTO `account_code` (`ACCOUNT_CODE`, `ACCOUNT_NAME`) VALUES
('100101', 'Sales'),
('100102', 'Due (Sales)'),
('100103', 'Purchase'),
('100104', 'Due (Purchase)'),
('100105', 'CASH/BANK'),
('100106', 'House or Shop Rent'),
('100107', 'Employee Salary'),
('100108', 'Other Expense');
...
('DIN-101-101-26021709515856', 'C-101-101-260105112410', '101-101-20260209-800003', 10500.00, '2026-02-17', 'Cash', NULL, 'riton', '2026-02-17 14:51:58', NULL, NULL, NULL, NULL, 'Y', 'riton', '2026-02-17 14:52:08', '101', '101-101'),
('DIN-101-101-26021709521838', 'C-101-101-260105112410', '101-101-20260209-800003', 4000.00, '2026-02-17', 'Cash', NULL, 'riton', '2026-02-17 14:52:18', 'riton', '2026-02-17 14:52:26', NULL, NULL, 'Y', 'riton', '2026-02-17 14:52:39', '101', '101-101');
...
('C-20260210051829697', 'Soikat', NULL, '01815572769', NULL, NULL, NULL, NULL, NULL, NULL, '2026-02-10 10:18:29', 'riton', NULL, NULL, NULL, NULL, NULL, '101', '101-101');
...
(49, 'Customer Previous Due', 'previous_due.php', 42),
(50, 'Customer Due Collection', 'due_collection.php', 42),
(51, 'Distributor Previous Due', 'distributor_previous_due.php', 42),
(52, 'Distributor Due Payment', 'distributor_due_collection.php', 42),
(53, 'Reset Password', 'reset_password.php', 1),
(54, 'Add Product Unit', 'add_unit.php', 2),
(55, 'Stock Report', 'stock_report_catagory_wise.php', 4),
(56, 'Stock rReport', 'stock_report_catagory_wise.php', 4),
(57, 'Stock Details', 'stock_report_details.php', 4);
...
('101', 'RS ELECTRONICS', 'Khagrachori', '', 'Y', NULL, NULL, NULL, NULL, '2025-10-15', 'softadmin', NULL, NULL);
...
('1013-025049', 'WFB 1G7GDXX', '1', '1', NULL, 'RITON', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '101', '101-101', 39690.00),
...
CREATE TABLE `sales_dtl` (
  ...
  `stock_mst_id` varchar(50) DEFAULT NULL,
  `stock_dtl_id` varchar(50) DEFAULT NULL,
...
INSERT INTO `sales_dtl` (`sales_dtl_id`, `sales_mst_id`, `model_id`, `stock_mst_id`, `stock_dtl_id`, `product_category_id`, `supplier_id`, `price`, `quantity`, `total`, `sub_total`, `original_price`, `commission_pct`, `commission_type`, `org_code`, `br_code`, `distributor_code`, `tds`, `grade`, `sales_voucher_ref`, `entry_user`, `entry_date`, `edit_user`, `edit_date`, `delete_user`, `delete_date`, `authorized_status`, `authorized_user`, `authorized_date`) VALUES
('101-101-D-20260209073932-7363', '101-101-20260209-800003', '634-180206', '101-101-STK-20260209-602545', '101-101-DTL-20260209072949807', '24', '1', 20500.00, 1.00, 20500.00, NULL, 20500.00, 0.00, 'PCT', '101', '101-101', NULL, NULL, NULL, '101-101-V-20260209-073812.628', 'riton', '2026-02-09 12:39:32', NULL, NULL, NULL, NULL, 'N', NULL, NULL),
('101-101-D-20260209090022-3585', '101-101-20260209-604843', '634-180206', '101-101-STK-20260209-059328', '101-101-DTL-20260209073115757', '24', '1', 20500.00, 1.00, 20500.00, NULL, 20500.00, 0.00, 'PCT', '101', '101-101', NULL, NULL, NULL, '101-101-V-20260209-085940.780', 'riton', '2026-02-09 14:00:22', NULL, NULL, NULL, NULL, 'N', NULL, NULL),
('101-101-D-20260210051829-1098', '101-101-20260210-352494', '1013-025049', '101-101-STK-20260209-059328', '101-101-DTL-20260209073115607', '1', '1', 35690.00, 1.00, 35690.00, NULL, 35690.00, 0.00, 'PCT', '101', '101-101', NULL, NULL, NULL, '101-101-V-20260210-051723.071', 'riton', '2026-02-10 10:18:29', NULL, NULL, NULL, NULL, 'N', NULL, NULL),
('101-101-D-20260217095117-1335', '101-101-20260217-905375', '634-180206', '101-101-STK-20260209-059328', '101-101-DTL-20260209073115757', '24', '1', 20500.00, 1.00, 20500.00, NULL, 20500.00, 0.00, 'PCT', '101', '101-101', NULL, NULL, NULL, '101-101-V-20260217-095057.953', 'riton', '2026-02-17 14:51:17', NULL, NULL, NULL, NULL, 'N', NULL, NULL);
...
('101-101-20260209-604843', '101-101-V-20260209-085940.780', '2026-02-09', '101', '101-101', 20500, 500, 20000.00, 20000.00, 0.00, 'riton', '2026-02-09 14:00:22', NULL, NULL, 'Y', 'riton', '2026-02-09 14:00:28', 'C-20251224113801545'),
('101-101-20260209-800003', '101-101-V-20260209-073812.628', '2026-02-09', '101', '101-101', 20500, 0, 20500.00, 0.00, 20500.00, 'riton', '2026-02-09 12:39:32', NULL, NULL, 'Y', 'riton', '2026-02-09 12:39:37', 'C-101-101-260105112410'),
('101-101-20260210-352494', '101-101-V-20260210-051723.071', '2026-02-10', '101', '101-101', 35690, 0, 35690.00, 0.00, 35690.00, 'riton', '2026-02-10 10:18:29', NULL, NULL, 'Y', 'riton', '2026-02-10 10:18:32', 'C-20260210051829697'),
('101-101-20260217-905375', '101-101-V-20260217-095057.953', '2026-02-17', '101', '101-101', 20500, 0, 20500.00, 0.00, 20500.00, 'riton', '2026-02-17 14:51:17', NULL, NULL, 'Y', 'riton', '2026-02-17 14:51:22', 'C-101-101-260105112410');

-- --------------------------------------------------------

--
-- Stand-in structure for view `stock_details_view`
-- (See below for the actual view)
--
CREATE TABLE `stock_details_view` (
...
,`stock_mst_id` varchar(50)
,`stock_dtl_id` varchar(50)
,`stock` decimal(10,2)
,`sold` decimal(32,2)
...
('101-101-DTL-20260209072949468', '101-101-STK-20260209-602545', '1013-025049', '1', '1', 35690.00, 10.00, 314072.00, 356900.00, NULL, 12.00, 'PCT', '101', '101-101', NULL, NULL, '', 'riton', '2026-02-09 12:29:49', NULL, NULL, NULL, NULL, 'N', NULL, NULL),
('101-101-DTL-20260209072949807', '101-101-STK-20260209-602545', '634-180206', '24', '1', 20500.00, 8.00, 149240.00, 164000.00, NULL, 9.00, 'PCT', '101', '101-101', NULL, NULL, '', 'riton', '2026-02-09 12:29:49', NULL, NULL, NULL, NULL, 'N', NULL, NULL),
('101-101-DTL-20260209072949955', '101-101-STK-20260209-602545', '1077-133847', '16', '1', 750.00, 7.00, 4462.50, 5250.00, NULL, 15.00, 'PCT', '101', '101-101', NULL, NULL, '', 'riton', '2026-02-09 12:29:49', NULL, NULL, NULL, NULL, 'N', NULL, NULL),
('101-101-DTL-20260209073115607', '101-101-STK-20260209-059328', '1013-025049', '1', '1', 35690.00, 7.00, 224847.00, 249830.00, NULL, 10.00, 'PCT', '101', '101-101', NULL, NULL, '', 'riton', '2026-02-09 12:31:15', NULL, NULL, NULL, NULL, 'N', NULL, NULL),
('101-101-DTL-20260209073115757', '101-101-STK-20260209-059328', '634-180206', '24', '1', 20500.00, 14.00, 252560.00, 287000.00, NULL, 12.00, 'PCT', '101', '101-101', NULL, NULL, '', 'riton', '2026-02-09 12:31:15', NULL, NULL, NULL, NULL, 'N', NULL, NULL);
...
('101-101-STK-20260209-059328', '978-7878', '2026-02-09', '101', '101-101', 477407, 0, 477407.00, 400000.00, 77407.00, 'riton', '2026-02-09 12:31:15', NULL, NULL, 'Y', 'riton', '2026-02-09 12:31:19', '1'),
('101-101-STK-20260209-602545', '63441.330', '2026-02-09', '101', '101-101', 467775, 0, 467774.50, 200000.00, 267774.50, 'riton', '2026-02-09 12:29:49', NULL, NULL, 'Y', 'riton', '2026-02-09 12:29:58', '1');
...
('r043', 2, 37, 0, NULL, NULL, NULL, 'raju', '2025-10-14', 'softadmin', '2026-02-18', NULL, NULL, '100', '100-100'),
('r044', 2, 33, 0, NULL, NULL, NULL, 'raju', '2025-10-14', 'softadmin', '2026-02-18', NULL, NULL, '100', '100-100'),
('r045', 2, 34, 0, NULL, NULL, NULL, 'raju', '2025-10-14', 'softadmin', '2026-02-18', NULL, NULL, '100', '100-100'),
('r046', 2, 30, 0, NULL, NULL, NULL, 'raju', '2025-10-14', 'softadmin', '2026-02-18', NULL, NULL, '100', '100-100'),
('r047', 2, 1, 1, NULL, NULL, NULL, 'raju', '2025-10-14', 'softadmin', '2026-02-18', NULL, NULL, '100', '100-100'),
('r048', 2, 5, 1, NULL, NULL, NULL, 'raju', '2025-10-14', 'softadmin', '2026-02-18', NULL, NULL, '100', '100-100'),
('r049', 2, 31, 0, NULL, NULL, NULL, 'raju', '2025-10-14', 'softadmin', '2026-02-18', NULL, NULL, '100', '100-100'),
('r050', 2, 27, 1, NULL, NULL, NULL, 'raju', '2025-10-14', 'softadmin', '2026-02-18', NULL, NULL, '100', '100-100'),
('r051', 2, 4, 1, NULL, NULL, NULL, 'raju', '2025-10-14', 'softadmin', '2026-02-18', NULL, NULL, '100', '100-100'),
('r052', 2, 2, 1, NULL, NULL, NULL, 'raju', '2025-10-14', 'softadmin', '2026-02-18', NULL, NULL, '100', '100-100'),
('r053', 2, 26, 1, NULL, NULL, NULL, 'raju', '2025-10-14', 'softadmin', '2026-02-18', NULL, NULL, '100', '100-100'),
('r055', 2, 28, 0, NULL, NULL, NULL, 'raju', '2025-10-14', 'softadmin', '2026-02-18', NULL, NULL, '100', '100-100'),
('r056', 2, 35, 0, NULL, NULL, NULL, 'raju', '2025-10-14', 'softadmin', '2026-02-18', NULL, NULL, '100', '100-100'),
('r057', 2, 32, 0, NULL, NULL, NULL, 'raju', '2025-10-14', 'softadmin', '2026-02-18', NULL, NULL, '100', '100-100'),
('r060', 1, 40, 1, NULL, NULL, NULL, 'raju', '2025-10-14', 'softadmin', '2025-10-22', NULL, NULL, '100', '100-100'),
('r062', 2, 40, 1, NULL, NULL, NULL, 'raju', '2025-10-14', 'softadmin', '2026-02-18', NULL, NULL, '100', '100-100'),
...
('r081', 2, 41, 1, NULL, NULL, NULL, 'softadmin', '2025-10-16', 'softadmin', '2026-02-18', NULL, NULL, '100', '100-100'),
...
('r084', 2, 42, 1, NULL, NULL, NULL, '', '0000-00-00', 'softadmin', '2026-02-18', NULL, NULL, '100', '100-100'),
('r085', 2, 43, 1, NULL, NULL, NULL, '', '0000-00-00', 'softadmin', '2026-02-18', NULL, NULL, '101', '101-101'),
...
('r090', 2, 44, 1, NULL, NULL, NULL, '', '0000-00-00', 'softadmin', '2026-02-18', NULL, NULL, '101', '101-101'),
...
('r101', 2, 46, 0, NULL, NULL, NULL, 'softadmin', '2025-10-28', 'softadmin', '2026-02-18', NULL, NULL, '100', '100-100'),
...
('r105', 2, 47, 1, NULL, NULL, NULL, 'softadmin', '2025-12-04', 'softadmin', '2026-02-18', NULL, NULL, '100', '100-100'),
('r106', 1, 48, 1, NULL, NULL, NULL, '', '0000-00-00', NULL, NULL, NULL, NULL, '100', '100-100'),
('r107', 2, 48, 1, NULL, NULL, NULL, 'softadmin', '2025-12-23', 'softadmin', '2026-02-18', NULL, NULL, '100', '100-100'),
...
('r110', 2, 49, 1, NULL, NULL, NULL, 'softadmin', '2025-12-24', 'softadmin', '2026-02-18', NULL, NULL, '100', '100-100'),
('r111', 2, 50, 1, NULL, NULL, NULL, 'softadmin', '2025-12-24', 'softadmin', '2026-02-18', NULL, NULL, '100', '100-100'),
('r112', 1, 51, 1, NULL, NULL, NULL, '', '0000-00-00', NULL, NULL, NULL, NULL, '100', '100-100'),
('r113', 2, 51, 1, NULL, NULL, NULL, 'softadmin', '2026-01-06', 'softadmin', '2026-02-18', NULL, NULL, '100', '100-100'),
('r114', 1, 52, 1, NULL, NULL, NULL, '', '0000-00-00', NULL, NULL, NULL, NULL, '100', '100-100'),
('r115', 2, 52, 1, NULL, NULL, NULL, 'softadmin', '2026-01-06', 'softadmin', '2026-02-18', NULL, NULL, '100', '100-100'),
...
('r129', 2, 53, 1, NULL, NULL, NULL, 'softadmin', '2026-01-28', 'softadmin', '2026-02-18', NULL, NULL, '100', '100-100'),
('r130', 1, 54, 1, NULL, NULL, NULL, '', '0000-00-00', NULL, NULL, NULL, NULL, '100', '100-100'),
('r131', 2, 54, 1, NULL, NULL, NULL, 'softadmin', '2026-01-29', 'softadmin', '2026-02-18', NULL, NULL, '100', '100-100'),
('r132', 1, 55, 1, NULL, NULL, NULL, '', '0000-00-00', NULL, NULL, NULL, NULL, '100', '100-100'),
('r133', 2, 55, 1, NULL, NULL, NULL, 'softadmin', '2026-02-17', 'softadmin', '2026-02-18', NULL, NULL, '100', '100-100'),
('r134', 2, 56, 0, NULL, NULL, NULL, 'softadmin', '2026-02-17', 'softadmin', '2026-02-18', NULL, NULL, '100', '100-100'),
('r135', 1, 57, 1, NULL, NULL, NULL, '', '0000-00-00', NULL, NULL, NULL, NULL, '100', '100-100'),
('r136', 2, 57, 1, NULL, NULL, NULL, 'softadmin', '2026-02-18', 'softadmin', '2026-02-18', NULL, NULL, '100', '100-100');
...
--
-- Structure for view `stock_details_view`
--
DROP TABLE IF EXISTS `stock_details_view`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `stock_details_view`  AS SELECT `sup`.`supplier_id` AS `supplier_id`, `sup`.`supplier_name` AS `supplier_name`, `pc`.`product_category_id` AS `product_category_id`, `pc`.`product_category_name` AS `product_category_name`, `d`.`entry_date` AS `stock_date`, `pm`.`MODEL_ID` AS `model_id`, `pm`.`MODEL_NAME` AS `model`, `d`.`price` AS `price`, `d`.`commission_type` AS `commission_type`, `d`.`commission_pct` AS `commission_pct`, CASE WHEN `d`.`commission_type` = 'PCT' THEN `d`.`price`- `d`.`price` * `d`.`commission_pct` / 100 WHEN `d`.`commission_type` = 'AMT' THEN `d`.`price`- `d`.`commission_pct` ELSE `d`.`price` END AS `buying_price`, `d`.`stock_mst_id` AS `stock_mst_id`, `d`.`stock_dtl_id` AS `stock_dtl_id`, `d`.`quantity` AS `stock`, coalesce(sum(`s`.`quantity`),0) AS `sold`, CASE WHEN coalesce(sum(`s`.`quantity`),0) > 0 THEN `d`.`quantity`- sum(`s`.`quantity`) ELSE CASE WHEN `smst`.`authorized_status` = 'Y' THEN `d`.`quantity` ELSE 0 END END AS `remaining`, `d`.`br_code` AS `br_code`, `d`.`org_code` AS `org_code` FROM ((((((`stock_dtl` `d` join `product_model` `pm` on(`pm`.`MODEL_ID` = `d`.`model_id`)) join `stock_mst` `smst` on(`d`.`stock_mst_id` = `smst`.`stock_mst_id` and `d`.`br_code` = `smst`.`br_code`)) join `supplier` `sup` on(`sup`.`supplier_id` = `d`.`supplier_id`)) join `product_category` `pc` on(`pc`.`product_category_id` = `d`.`product_category_id`)) left join `sales_dtl` `s` on(`s`.`model_id` = `d`.`model_id` and `s`.`product_category_id` = `d`.`product_category_id` and `s`.`supplier_id` = `d`.`supplier_id` and `s`.`stock_mst_id` = `d`.`stock_mst_id` and `s`.`stock_dtl_id` = `d`.`stock_dtl_id`)) left join `sales_mst` `sm` on(`s`.`sales_mst_id` = `sm`.`sales_mst_id` and `s`.`br_code` = `sm`.`br_code` and `sm`.`authorized_status` = 'Y')) WHERE `d`.`quantity` > 0 GROUP BY `sup`.`supplier_id`, `sup`.`supplier_name`, `pc`.`product_category_id`, `pc`.`product_category_name`, `d`.`entry_date`, `pm`.`MODEL_ID`, `pm`.`MODEL_NAME`, `d`.`price`, `d`.`commission_pct`, `d`.`commission_type`, `d`.`stock_mst_id`, `d`.`stock_dtl_id`, `d`.`quantity`, `smst`.`authorized_status` HAVING `remaining` > 0 ORDER BY `pm`.`MODEL_NAME` ASC ;
...
ALTER TABLE `sales_dtl`
  ...
  ADD KEY `fk_stock_dtl` (`stock_dtl_id`);
...
--
ALTER TABLE `sales_dtl`
  ADD CONSTRAINT `fk_stock_dtl` FOREIGN KEY (`stock_dtl_id`) REFERENCES `stock_dtl` (`stock_dtl_id`),
  ADD CONSTRAINT `fk_stock_mst` FOREIGN KEY (`stock_mst_id`) REFERENCES `stock_mst` (`stock_mst_id`);
